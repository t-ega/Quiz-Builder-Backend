      ...
      <div className="quiz-entry">
        ...
        <div className="question-card">
          ...
          <p>
            ...
            adipisci, aliquam quo amet id dolore alias! Sunt impedit numquam eos
            laudantium in tempore aliquid iure, ex autem earum dolores laborum!
          </p>
